...
{
	registry->WriteInt("ScreenBPP", registry->ReadInt("LastWorkingScreenBPP", 16));
	registry->WriteInt("LScreenHeight", registry->ReadInt("LastWorkingScreenHeight", 640));
	registry->WriteInt("ScreenWidth", registry->ReadInt("LastWorkingScreenWidth", 480));

	registry->WriteString("EngineDLL", registry->ReadString("LastWorkingEngineDLL", HARDWARE_ENGINE));		
...
int CALLBACK WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
	...
	do
	{
		...
		case 0:					
			...
			break;
		case 1:
			registry->WriteInt("LastWorkingScreenBPP", registry->ReadInt("ScreenBPP", 16));
			registry->WriteInt("LastWorkingScreenHeight", registry->ReadInt("ScreenHeight", 640));
			registry->WriteInt("LastWorkingScreenWidth", registry->ReadInt("ScreenWidth", 480));

			registry->WriteString("LastWorkingEngineDLL", registry->ReadString("EngineDLL", HARDWARE_ENGINE));		
			bRestartEngine = true;
			break;
		case 2:
